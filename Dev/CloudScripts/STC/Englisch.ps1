...
if ($WindowsPhase -eq 'WinPE') {
    ...
    iex (irm https://raw.githubusercontent.com/JorgaWetzel/garytown/master/Dev/CloudScripts/win11UK.ps1)
    ...
    Add-Content -Path $PSFilePath 'iex (irm https://raw.githubusercontent.com/JorgaWetzel/garytown/master/Dev/CloudScripts/STC/Englisch.ps1)'
...
if ($WindowsPhase -eq 'OOBE') {
    ...
    $InputMethod = '0809:00000809' # Das Layout für Englisch (Grossbritannien)
    ...
    C:\ProgramData\chocolatey\bin\choco.exe install office365business --params "'/exclude:Access Groove Lync Publisher /language:en-GB /eula:FALSE'" -y --no-progress --ignore-checksums
