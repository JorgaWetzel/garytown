...
try {
    ...
    $packages = @(
        "TeamViewer","googlechrome","firefox","adobereader",
        "microsoft-teams-new-bootstrapper","7zip.install","vlc","jre8",
        "powertoys","onedrive","vcredist140","zoom",
        "notepadplusplus.install","onenote","onedrive"
    )
